...
public class EnchantmentCraftingTableTileEntity extends TileEntity implements INameable, ITickableTileEntity {
    public int tickAccumulator;
    public float f, g, h, i, j, k, l, m, n;
    private static final Random random = new Random();
    private ITextComponent customName;

    public EnchantmentCraftingTableTileEntity() {
        super(TileEntities.ENCHANTMENT_CRAFTING_TABLE.get());
    }
    ...
    public ITextComponent getName() {
        return this.customName != null ? this.customName : new TranslationTextComponent(EnchantmentsReloaded.MOD_ID + ".container.enchantment_crafting_table");
    }
