...
@OnlyIn(Dist.CLIENT)
public class CopyTableTileEntityRenderer extends TileEntityRenderer<CopyTableTileEntity> {
    ...
    public CopyTableTileEntityRenderer(TileEntityRendererDispatcher dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(CopyTableTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
        matrixStackIn.push();
