...
@OnlyIn(Dist.CLIENT)
public class EnchantmentCraftingTableTileEntityRenderer extends TileEntityRenderer<EnchantmentCraftingTableTileEntity> {
    ...
    public EnchantmentCraftingTableTileEntityRenderer(TileEntityRendererDispatcher dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(EnchantmentCraftingTableTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
        matrixStackIn.push();
